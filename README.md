...
![Classic Wolfenstein 3D raycasting view](https://lodev.org/cgtutor/images/wolf3d.jpg)

![Top-down map editor mode](https://lodev.org/cgtutor/images/wolfmapedit.jpg)

![Modern raycasting demo with split view](https://austinhenley.com/blog/images/raycastingdemo.png)

![Simple raycaster in C (similar style)](https://external-preview.redd.it/a-simple-raycaster-game-in-c-v0-d203NTY2dmtkeXJkMc4sujC9o6lKEqUwo_oVKZgMqQg7Ng9cY-8DCqcAT07p.png?format=pjpg&auto=webp&s=43b349a9f35cb9117c9f28826edb6ff7079d1248)

![Raycasting with Raylib example](https://preview.redd.it/oze1fzu02oe61.gif?width=637&auto=webp&s=99e31bd1b7f8f2cc3a41fa7877e77d1878a46a96)
...
- **Player movement** → WASD for translation, arrow keys for rotation (frame-rate independent)
...
- No external 3D engines or pre-built cameras – everything rendered manually with `DrawLine`!
